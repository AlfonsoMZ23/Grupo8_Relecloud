...
SECRET_KEY = 'django-insecure-+%zemdq*5_ax99c1y%ol20nevwkgd*r3pf15^c6urbq2)(d6&l'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'alfonso-moreno-relecloud.azurewebsites.net',
    '127.0.0.1',
...
CSRF_TRUSTED_ORIGINS = ['https://alfonso-moreno-relecloud.azurewebsites.net',
                        'https://*.alfonso-moreno-relecloud.azurewebsites.net',
                        'https://alfonso-moreno-relecloud.azurewebsites.net.*',
                        'https://grupo8-relecloud.azurewebsites.net',
                        'https://*.grupo8-relecloud.azurewebsites.net',
